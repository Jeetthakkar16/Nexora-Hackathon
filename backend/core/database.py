...
CREATE TABLE IF NOT EXISTS sos_events (
 id INTEGER PRIMARY KEY AUTOINCREMENT,
 vehicle_id INTEGER, latitude REAL NOT NULL, longitude REAL NOT NULL,
 trigger TEXT NOT NULL, severity TEXT NOT NULL, message TEXT NOT NULL,
 status TEXT NOT NULL DEFAULT 'PREPARED', police_json TEXT NOT NULL,
 created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
 FOREIGN KEY(vehicle_id) REFERENCES vehicles(id)
);
